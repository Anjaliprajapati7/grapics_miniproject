...
import cubeblock as cube_file
import mazepath as map_file
...
#validate whether a given new position is a vald move within the game map
...
#iterates over the list and draw each cube 
def drawGround():
